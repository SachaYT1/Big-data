...
SCHEMA_SQL = Path(__file__).with_name("schema_postgres.sql")
...
def main():
    parser = argparse.ArgumentParser(description="Ingest Foursquare slice into PostgreSQL")
